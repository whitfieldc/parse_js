  ...
  module Visitors
    class EvaluationVisitor < Visitor
      ...
      def visit_SubtractNode(o)
        ParseJS::JS::Property.new(:subtract,
      ...
      def visit_MultiplyNode(o)
        ...
        return_val = 
          if [left, right].any? { |x| x.respond_to?(:nan?) && x.nan? }
            ...
            } ? ParseJS::JS::NaN.new : left * right
          end
        ParseJS::JS::Property.new(:multiple, return_val)
      end
      ...
      def visit_DivideNode(o)
        ...
        ParseJS::JS::Property.new(:divide, return_val)
      end
      ...
      def visit_NumberNode(o)
        ParseJS::JS::Property.new(o.value, o.value)
      end

      def visit_VoidNode(o)
        o.value.accept(self)
        ParseJS::JS::Property.new(:undefined, :undefined)
      end

      def visit_NullNode(o)
        ParseJS::JS::Property.new(nil, nil)
      end

      def visit_TrueNode(o)
        ParseJS::JS::Property.new(true, true)
      end

      def visit_FalseNode(o)
        ParseJS::JS::Property.new(false, false)
      end

      def visit_StringNode(o)
        ParseJS::JS::Property.new(:string,
          o.value.gsub(/\A['"]/, '').gsub(/['"]$/, '')
        )
      end
      ...
      def visit_EqualNode(o)
        ...
        ParseJS::JS::Property.new(:equal_node, left.value == right.value)
      end
      ...
      def visit_BitwiseNotNode(o)
        ...
        ParseJS::JS::Property.new(nil, ~number.value)
      end
      ...
      def visit_TypeOfNode(o)
        ...
        return ParseJS::JS::Property.new(:string, 'object') if val.value.nil?

        case val.value
        when String
          ParseJS::JS::Property.new(:string, 'string')
        when Numeric
          ParseJS::JS::Property.new(:string, 'number')
        when true
          ParseJS::JS::Property.new(:string, 'boolean')
        when false
          ParseJS::JS::Property.new(:string, 'boolean')
        when :undefined
          ParseJS::JS::Property.new(:string, 'undefined')
        else
          ParseJS::JS::Property.new(:object, 'object')
        end
      end
      ...
      def to_number(object)
        return ParseJS::JS::Property.new('0', 0) unless object.value
        ...
        return_val =
          ...
          when ParseJS::JS::Base
            return to_number(to_primitive(object, 'Number'))
          end
        ParseJS::JS::Property.new(nil, return_val)
      end

      def to_boolean(object)
        return ParseJS::JS::Property.new(false, false) unless object.value
        value = object.value
        boolean =
          case value
          when :undefined
        ...
        ParseJS::JS::Property.new(boolean, boolean)
      end
      ...
      def to_int_32(object)
        ...
        if value.respond_to?(:nan?) && (value.nan? || value.infinite?)
          ParseJS::JS::Property.new(nil, 0)
        end
        value = ((value < 0 ? -1 : 1) * value.abs.floor) % (2 ** 32)
        if value >= 2 ** 31
          ParseJS::JS::Property.new(nil, value - (2 ** 32))
        else
          ParseJS::JS::Property.new(nil, value)
        end
      end
      ...
      def to_primitive(object, preferred_type = nil)
        ...
        when false, true, :undefined, ::String, Numeric
          ParseJS::JS::Property.new(nil, object.value)
        when ParseJS::JS::Base
