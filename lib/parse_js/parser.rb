require 'parse_js/tokenizer'
require 'parse_js/generated_parser'


module ParseJS
  class Parser < ParseJS::GeneratedParser
    TOKENIZER = Tokenizer.new

    ParseJS::GeneratedParser.instance_methods.each do |im|
    ...
    def next_token
      ...
      if @terminator &&
        ...
        @position -= 1
        return (@prev_token = ParseJS::Token.new(';', ';')).to_racc_token
      end
